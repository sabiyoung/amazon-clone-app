...
app.post("/api/create-adress", authHandler, function (req, res) {
    const user = req.user._id;
    const { firstName, lastName, adressLineOne, adressLineTwo, zipCode, state, city, phoneNumber, email, } = req.body;
...
app.get("/api/adress", authHandler, function (req, res) {
...
app.post("/api/create-rating", function (req, res) {
...
app.put("/api/delete-from-cart/:id", authHandler, function (req, res) {
...
app.get("/api/order", authHandler, function (req, res) {
